...
\begin{frame}{Basic Reproduction Number: $\mathscr{R}_{0}$}
    \begin{block}{Definition}
        \begin{itemize}
            ...
            \item $\mathscr{R}_{0}$ is defined as the expected number of secondary cases produced by a single macroalgae (M) in a completely coral (C) population. % def in terms of our model
        \end{itemize}
    \end{block}
\end{frame}
