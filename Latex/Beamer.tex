...
\begin{frame}{Endemic Equilibrium}
    ...
    \begin{align*}
        ...
        &= \frac{\omega \left(\beta \left(1- \left(\frac{\mu_{1} + a(t)M^{*}}{r} + M^{*} \right) \right) \left(\frac{q-(h+\mu_{2})}{q} \right) \right)}{\beta(a(t) \left(1- \left(\frac{\mu_{1} + a(t)M^{*}}{r} + M^{*} \right) \right)+\phi \left(\frac{\mu_{1} + a(t)M^{*}}{r} \right))} - \frac{\mu_{1} + a(t)M^{*}}{r}
    \end{align*}
    }}
\end{frame}
...
\begin{frame}{Threshold}
    \begin{columns}
        \begin{column}{0.55 \textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=\textwidth]{Latex/Figures/Graphs/threshold.png}
