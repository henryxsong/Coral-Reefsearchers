...
\begin{frame}{Background}
    \begin{itemize}
        ...
        \item<2-> They play a crucial role in the marine ecosystem's biodiversity along with other functions, such as coastal defense from storms and economic benefits from tourism or local fisheries$^\cite{04_mathanalysis}$.
        \item<3-> Factors that affect coral reefs include climate change, coral reef resilience$^\cite{02_Riegl_Purkis_Model}$, and exploitative fishing practices$^\cite{05_quintero_machuca_cotto_bradley_ríos-soto_2016}$.
