...
\begin{frame}{Coral Reef Ecosystem Model Parameters}
    ...
    \begin{tabular}{c p{5cm} c c}
        ...
        $r$ & rate that coral recruit to overgrow algal turfs & 0.5\textsuperscript{\cite{16_wolanski_richmond_mccook_2004}} & $year^{-1}$\\ %12
...
\begin{frame}{Simulating $a(t)$}
    ...
    \begin{center}
        \animategraphics[width=0.9\textwidth, loop, autoplay]{12}{Latex/Figures/sine_graph_animation/frame-}{0}{158}
    \end{center}
\end{frame}
...
\begin{frame}{Parameter Changes: $a_{0}$}
    \begin{center}
        \animategraphics[width=0.85\textwidth, loop, autoplay]{2}{Latex/Figures/a_animation/frame-}{1}{45}\\
...
\begin{frame}{Parameter Changes: $h$}
    \begin{center}
        \animategraphics[width=0.85\textwidth, loop, autoplay]{2}{Latex/Figures/h_animation/frame-}{1}{49}\\
        Initial Compartment Conditions: $C=T=M=\frac{1}{3}$ \& $P=\frac{3}{4.}$
    \end{center}
\end{frame}

% \begin{frame}{Compartment Population Changes}
%     \begin{figure}%
%         \centering
%         \subfloat[\centering $C = T = M = \frac{1}{3}$, and $P = 1$]{{\includegraphics[width=0.5\textwidth]{Latex/Figures/initial_matlab_plot.png} }}%
%         \subfloat[\centering $C = \frac{1}{2}$, $T = M = \frac{1}{4}$, and $P = 1$]{{\includegraphics[width=0.5\textwidth]{Latex/Figures/0.5C_0.25T_0.25M.png} }}%
%         % \\
%         % \subfloat[\centering $T = \frac{1}{2}$, $C = M = \frac{1}{4}$, and $P = 1$]{{\includegraphics[width=0.5\textwidth]{Latex/Figures/0.25C_0.5T_0.25M.png} }}%
%         % \subfloat[\centering $M = \frac{1}{2}$, $C = T = \frac{1}{4}$, and $P = 1$]{{\includegraphics[width=0.5\textwidth]{Latex/Figures/0.25C_0.25T_0.5M.png} }}%
%         %\caption{Images of Ecosystem}%
%         %\label{fig:graphs}%
%     \end{figure}
% \end{frame}
% \begin{frame}{Compartment Population Changes (Cont.)}
%     \begin{figure}%
%         \centering
%         % \subfloat[\centering $C = T = M = \frac{1}{3}$, and $P = 1$]{{\includegraphics[width=0.6\textwidth]{Latex/Figures/initial_matlab_plot.png} }}%
%         % \subfloat[\centering $C = \frac{1}{2}$, $T = M = \frac{1}{4}$, and $P = 1$]{{\includegraphics[width=0.6\textwidth]{Latex/Figures/0.5C_0.25T_0.25M.png} }}%
%         % % \\
%         \subfloat[\centering $T = \frac{1}{2}$, $C = M = \frac{1}{4}$, and $P = 1$]{{\includegraphics[width=0.5\textwidth]{Latex/Figures/0.25C_0.5T_0.25M.png} }}%
%         \subfloat[\centering $M = \frac{1}{2}$, $C = T = \frac{1}{4}$, and $P = 1$]{{\includegraphics[width=0.5\textwidth]{Latex/Figures/0.25C_0.25T_0.5M.png} }}%
%         % \caption{Images of Ecosystem}%
%         \label{fig:pop_changes}%
%     \end{figure}
% \end{frame}
...
%\begin{frame}{Endemic Equilibrium: P* Calculation}
 %   \begin{align*}
    ...
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \begin{align*}
                ...
                F & = [a(t)C+\gamma T^{0}]
            \end{align*}
            % $$\mathscr{F} = \begin{bmatrix} aCM+\gamma MT \end{bmatrix}$$
            % $$\downarrow$$
            % $$F = \begin{bmatrix} aC + \gamma T^{0} \end{bmatrix}$$
        \end{column}
        \begin{column}{0.5\textwidth}
            \begin{align*}
            ...
            % $$V = \begin{bmatrix} \frac{g(P)T^{0}}{(M + T)^{2}} \end{bmatrix}$$
            % $$\downarrow$$
            % $$V^{-1} = \begin{bmatrix} \frac{T^{0}}{g(P)} \end{bmatrix}$$
        \end{column}
    \end{columns}
    \quad
...
\end{frame}
% \begin{frame}{Basic Reproduction Number: $\mathscr{R}_{0}$}
%     $$\mathscr{F} = \begin{bmatrix} aCM+\gamma MT \end{bmatrix} \quad \quad \mathscr{V} = \begin{bmatrix} \frac{g(P)M}{M+T} \end{bmatrix}$$
%     $$\downarrow \quad \quad \quad \quad \quad \quad \downarrow$$
%     $$F = \begin{bmatrix} aC + \gamma T \end{bmatrix} \quad V = \begin{bmatrix} \frac{g(P)T}{(M + T)^{2}} \end{bmatrix}$$
%     $$\searrow \quad \quad \quad \quad \quad \swarrow$$
%     $$\mathscr{R}_{0} = \det(F * V^{-1})$$
%     $$\downarrow$$
