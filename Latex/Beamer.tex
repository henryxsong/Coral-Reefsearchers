...
\begin{frame}{Definitions}
    \begin{figure}%
        \centering
        \subfloat[\centering Coral Reefs]{{\includegraphics[width=5cm]{Latex/Figures/coral_reefs.jpg} }}%
        \\
        \subfloat[\centering Algal Turfs]{{\includegraphics[width=3.5cm]{Latex/Figures/algal_turf.jpg} }}%
        \qquad
        \subfloat[\centering Macroalgae]{{\includegraphics[width=3.5cm]{Latex/Figures/macroalgae.jpg} }}%
...
\begin{frame}{Coral Reef Ecosystem Model Parameters}
    ...
    \begin{tabular}{c p{7cm} c}
        ...
        $a$ & rate that coral is overgrown by macroalgae & $\frac{1}{yrs}$\\ % unknown
        ...
        $\gamma$ & rate that macroalgae spread vegetative over algal turfs & $\frac{1}{yrs}$\\ % unknown
        $q$ & intrinsic growth rate for parrotfish & 0.47$^\cite{12_noaa_report}\\
        $\beta$ & carrying capacity of parrotfish & \\ % unknown
        $h$ & harvesting rate for parrotfish & 0.14$^\cite{12_noaa_report}$\\
        $\alpha$ & maximum grazing intensity & \\ % unknown
        \hline
    \end{tabular}
...
\begin{frame}{Coral Reef Ecosystem Model$^\cite{04_mathanalysis}$}
\begin{center}
