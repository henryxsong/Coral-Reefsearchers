...
\begin{frame}{Definitions (Cont.)}
    \begin{columns}
        ...
        \begin{column}{0.5\textwidth}
            \begin{itemize}
                \item Parrot fish are common reef fish found in many tropical reefs\textsuperscript{\cite{13_blackwood_hastings_mumby_2010}}.
...
\begin{frame}{Coral Ecosystem Model Dynamics (Cont.)}
    \begin{figure}
        \centering
        \includegraphics[width=1\textwidth]{Latex/Figures/0.25C_0.5T_0.25M.png}
