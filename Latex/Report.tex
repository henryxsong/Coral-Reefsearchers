...
\begin{align*}
        C^{*} &= 1-T-M \\
        % rTC + \sigma PC - (a(t)M+\mu_{1})C\\
        P^{*} &= \beta C \left(\frac{q-(h+\mu_{2})}{q}\right)\\
        T^{*} &= \frac{\mu_{1} + a(t)M}{r} \\
        %T^{2}(rC+\phi M) + T(MrC + M^{2} + \mu_{1}C) - \left(\frac{\omega P}{\beta}M + \mu_{1} CM\right)\\
...
\begin{align*}
    lol I dont remember the equation, I'll put in tomorrow
\end{align*}
...
\appendix
    ...
    \section{MatLab Code}
        ...
        \begin{center}
            \lstinputlisting[language=Matlab, firstline = 185, lastline = 207]{./Source Code/Coral_Reefsearchers.m}
        \end{center}
        ...
        \begin{center}
            \lstinputlisting[language=Matlab, firstline = 218, lastline = 248]{./Source Code/Coral_Reefsearchers.m}
        \end{center}
        ...
        \label{appendix:B6}
        \begin{center}
            \lstinputlisting[language=Matlab, firstline = 253, lastline = 268]{./Source Code/Coral_Reefsearchers.m}
        \end{center}
        ...
        \begin{center}
            \lstinputlisting[language=Matlab, firstline = 273, lastline = 315]{./Source Code/Coral_Reefsearchers.m}
        \end{center}
\newpage
% \bibliography{main}
