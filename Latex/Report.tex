...
\begin{align*}
        ...
        T^{*} &= T^{2}(rC+\phi M) + T(MrC + M^{2} + \mu_{1}C) - \left(\frac{\omega P}{\beta}M + \mu_{1} CM\right)\\
...
\appendix
    \section{MatLab Code}
        ...
        \begin{center}
            ...
            %\lstinputlisting[language=Matlab, firstline = 1, lastline = 10]{./Source Code/Coral_Reefsearchers.m}
