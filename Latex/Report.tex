...
\begin{table}[H]
    ...
    \begin{tabular}{c c c}
        ...
        \hline
         & natural death rate of coral reefs & \\
         & natural death rate of parrotfish & \\
         & rate that coral is overgrown by macroalgae & \\
         & rate that coral recruit to overgrow algal turfs & \\
         & grazing rate that parrotfish graze macroalgae without distinction from algae turfs & \\
         & rate that macroalgae spread vegetative over algal turfs & \\
         & intrinsic growth rate for parrotfish & \\
         & & \\
